...
$graphSrc="graph.php";
//localhost/graph.php?label1=value1&label2=value2&label3=value3&label4=value4&label5=value5
...
<body>
	...
	/*$vertibas = new Array();
	for ($i = 1; $i <= 5; $i++) {
    echo "$vertibas[i] = $label + ($i + 1)).value;";
	}*/
	 ...
	 if(!is_numeric($value1) || !isset($label1)){
                echo "Ievadiet pirma stabina vertibas kartigi, ka pienakas";
	 ...
	 /*if ($_GET["label1"] !='')
	 { return true;
	 }else {echo "Lauks nav aizpildîts";}
	*/
	?>

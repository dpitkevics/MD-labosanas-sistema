...
if ($_POST) {
    $arr= array('label1'=>$_POST['label1'],'label2'=>$_POST['label2'],'label3'=>$_POST['label3'],
            'label4'=>$_POST['label4'],'label5'=>$_POST['label5'],'value1'=>$_POST['value1'],
            'value2'=>$_POST['value2'],'value3'=>$_POST['value3'],'value4'=>$_POST['value4'],
            'value5'=>$_POST['value5']);

    $graphSrc='graph.php?' . http_build_query($arr, '', '&amp;');
}
